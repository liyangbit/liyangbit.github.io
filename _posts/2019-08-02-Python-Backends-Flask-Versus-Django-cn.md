...
![img04](/images/posts/Python-Backends-Flask-Versus-Django/4.png)
...
![img05](/images/posts/Python-Backends-Flask-Versus-Django/5.png)

Django 使用内置的模板引擎，允许开发人员毫不费力地定义 Web 应用程序的面向用户的层。 此外，开发人员可以使用 Django 模板语言（DTL）编写模板来创建自定义用户界面开发。 Django 中的模板语法包括：

![img06](/images/posts/Python-Backends-Flask-Versus-Django/6.png)
